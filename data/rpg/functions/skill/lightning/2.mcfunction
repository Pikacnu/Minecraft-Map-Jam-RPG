...
execute positioned ~ ~ ~ facing ^ ^ ^ if predicate rpg:25 run function rpg:lightning/3

execute positioned ^ ^ ^.5 if score #raycast temp matches 1.. run function rpg:lightning/2
